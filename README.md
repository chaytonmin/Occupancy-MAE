...
Repository for our arxiv paper ["Voxel-MAE: Masked Autoencoders for Pre-training Large-scale Point Clouds"](xx).
...
| Voxel-MAE+PV-RCNN (AnchorHead                                | **75.93**/**75.27** | **67.97**/**67.34** | **74.03**/**63.55** | **64.92**/**55.55** | **67.17**/**65.54** | **64.63**/**63.07** | [model](https://drive.google.com/file/d/14vIDI5mXRJbbcU1168OtFG1k6MyS1oaJ/view?usp=sharing) |      [model]([Pre-trained model will be provided soon.](https://drive.google.com/file/d/1Z8B6eMRrFQZK9-UEomNiwGA6YRFqzrXT/view?usp=sharing))       |
